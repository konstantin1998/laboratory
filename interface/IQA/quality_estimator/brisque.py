...
def scale_features(features):
    with open("IQA/quality_estimator/normalize.pickle", 'rb') as handle:
...
def calculate_image_quality_score(brisque_features):
    model = svmutil.svm_load_model("IQA/quality_estimator/brisque_svm.txt")
...
def get_brisque_score(gray_image, kernel_size=7, sigma=1.5):
  brisque_features = calculate_brisque_features(gray_image, kernel_size, sigma)
